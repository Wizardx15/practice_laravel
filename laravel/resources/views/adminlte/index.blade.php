...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    ...
    <header class="main-header">
        ...
        <div class="navbar-custom-menu">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="box box-success">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/dist/img/user4-128x128.jpg" alt="user image" class="online">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/dist/img/user2-160x160.jpg" alt="user image" class="offline">
